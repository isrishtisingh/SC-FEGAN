...
class Ex(QWidget, Ui_Form):
    ...
    def make_noise(self):
        ...
        noise = np.random.normal(size=(1, 512, 512, 3), scale=np.sqrt(2))
    ...
    def make_mask(self, pts):
        # Load the mask image
        mask = cv2.imread("mask6.png", cv2.IMREAD_GRAYSCALE)
    ...
    def make_sketch(self, pts):
        ...
        sketch = cv2.imread("sketch6.png", cv2.IMREAD_GRAYSCALE)
